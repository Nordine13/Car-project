  ...
  <section class=" py-4 py-md-5 py-xl-8 border-top ">
    <div class="container overflow-hidden">
      <div class="row gy-4 gy-lg-0 justify-content-xl-between">
        ...
        <div class="col-12 col-md-4 col-lg-3 col-xl-2">
          <div class="widget">
            <h4 class="widget-title mb-4 link-light">Get in Touch</h4>
            <address class="mb-4 link-light">8014 Edith Blvd NE, Albuquerque, France</address>
            <p class="mb-1">
...
if ($result->num_rows > 0) {
    echo '<div class="col-12 col-lg-3 col-xl-4">
            <div class="">
              <h4 class="mb-4 link-light">Opening Hours</h4>
              <p class="mb-4 link-light">';
