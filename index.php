...
<nav class="custom-navbar navbar  navbar-expand-md navbar-dark bg-dark">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            ...
            <div class="d-flex">
              <a href="signin.php"><button class="btn btn-success ms-3 bg-success">Sign in</button></a> 
...
<br>
    ...
    <section id="home" class="text-center">
        <div class="container">
            ...
            <img src="https://platform.cstatic-images.com/ad-creative/dd1eb234-bbfb-4fd0-8019-f8f88fcd7bd3/20240130_7530_Kia_Superbowl_Hero_V2.jpg?w=828" alt="Snow" style="width:100%;">
               <a href=""><div class="text-block">
                    <h4>Used CAR DEALERS</h4>
                    <p>EXPLORE NEW KIA SPORTAGE </p>
                </div></a> 
        </div>
    </section>
    <br>
  ...
  <div class="container">
    <div class="row justify-content-md-center">
      <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
        <h2 class="mb-4 display-5 text-center hover-div" style="color:black;">Contact US</h2>
      ...
      <div class="row gy-4 gy-lg-0 justify-content-xl-between">
        ...
        <div class="col-12 col-md-4 col-lg-3 col-xl-2">
          <div class="widget">
            ...
            <address class="mb-4">8014 Edith Blvd NE, Albuquerque, France</address>
            <p class="mb-1">
              <a class="link-light text-decoration-none" href="tel:+15057922430">(505) 792-2430</a>
            </p>
            <p class="mb-0">
              <a class="link-light text-decoration-none" href="mailto:your@yourdomain.com">your@yourdomain.com</a>
            </p>
          </div>
        </div>
        <div class="col-12 col-md-4 col-lg-3 col-xl-2">
          <div class="">
            ...
            <ul class="list-unstyled">
              ...
              <li class="mb-2">
                <a href="#!" class="link-light text-decoration-none">Testonomial</a>
              </li>
              <li class="mb-2">
                <a href="#!" class="link-light text-decoration-none">Book An Appoinment</a>
              </li>
